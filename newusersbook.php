...
$docname=$_GET['doctorname'];


      $hat = "SELECT * from `doctors` WHERE `name`= '$docname'";
...
?>
    ...
    <form method="post">
         ...
         <div class="row">
            <div class="col">
                <div class="form-group"> 
                    <label class="flabel" for="firstus" >User Name</label>
                    <input type="text" class="form-control" id="firstus" name="username" placeholder="User name" style="width: 100%;" value="<?php if(empty($username)){}else{echo $username;}; ?>">
                </div>
            </div>
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input class="custom-select" name="doctorname" id="doctorname"  value="<?php echo($docname)?>"/>
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="phoneno" min="1" max="11" placeholder="Enter your Number" name="phoneno" value="<?php if(empty($phoneno)){}else{echo $phoneno;}; ?>">
            </div>
        </div>
    </div>
  ...
  <!-- <input type="submit" name="checkout" value="Add Sponsor" /> -->
...
if(isset($_POST['checkout'])){
   ...
   $doctorid = $_GET['id'];
    ...
    VALUES ('$useremail','$username','$docname','$doctorid','$phoneno','$day','$dateto','$datefrom','$status','new user')";
...
header("location:newuserpay.php?doctorname=$docname");
